...
当前版本为 **v1.19.1**，线上部署于 `life.snowmoon1824.top`。
...
| 日历 | 日、周、月视图，展示普通任务与循环任务，并按开始时间稳定排序 |
| 项目 | 查看关联任务，编辑项目阶段、状态和目标日期，管理真实完成进度并安全删除 |
| 习惯 | 每周打卡、编辑频率与进行日、补签控制、连续完成统计和安全删除 |
...
| `v1.14.1` | 2026-08-12 | 修复晨间自动弹窗覆盖通知目标任务的问题 |
| `v1.14.2` | 2026-08-12 | 限制每日流程弹窗只在“今日”主页自动出现 |
| `v1.15.0` | 2026-08-12 | 加入任务与习惯安全清空，并修复晨间重复项和跨日专注计时 |
| `v1.16.0` | 2026-08-12 | 加入可按当前生活设置生成 Life Plan JSON 的 ChatGPT 提示词 |
| `v1.17.0` | 2026-08-13 | 加入服务器备份删除与固定高度滚动列表 |
| `v1.18.0` | 2026-08-13 | 补齐项目详情、编辑、关联任务查看和安全删除流程 |
| `v1.19.0` | 2026-08-13 | 补齐习惯详情、编辑和安全删除，并修正日历时间排序 |
| `v1.19.1` | 2026-08-18 | 修正日历事件的分钟位置、真实时长和重叠布局 |
