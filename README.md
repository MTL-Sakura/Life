...
当前版本：**v1.19.0** · [项目全景](PROJECT_OVERVIEW.md) · [完整版本记录](CHANGELOG.md) · [发布流程](docs/RELEASE_PROCESS.md) · [GitHub Releases](https://github.com/MTL-Sakura/Life/releases)
...
- 收集箱与任务状态筛选
- 日、周、月日历视图，同一时段的日程按开始时间稳定排序
- 项目详情与完整管理：查看阶段和关联任务，编辑名称、领域、日期、状态与阶段，删除时保留任务并移到未分类
- 习惯详情与完整管理：每周打卡、编辑计划、控制补签、查看连续记录并安全删除
- 周度完成率、时间投入和文字回顾
...
- 服务器备份支持下载、恢复和单条删除，历史列表在固定区域内滚动并自动轮换
